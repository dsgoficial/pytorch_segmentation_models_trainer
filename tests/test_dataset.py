...
class Test_TestDataset(CustomTestCase):
    ...
    def test_coco_dataset(self):
        coco_ds = CocoDatasetConfig(
            ...
            annotations=[
                ...
                AnnotationConfig(
                    ...
                    category_id=22,
                    iscrowd=0,
                    segmentation=[[376.81, 238.8, 378.19, 228.91, 382.15, 216.06, 383.14, 210.72, 385.9, 207.56, 386.7, 207.16, 387.29, 201.43, 389.27, 197.67, 396.58, 196.09, 404.49, 198.07, 416.16, 190.95, 434.75, 189.76, 458.48, 190.95, 468.96, 196.88, 473.51, 205.58, 473.31, 210.52, 460.65, 225.36, 447.6, 238.41, 437.91, 239.59, 420.91, 233.07, 413.98, 246.71, 406.27, 245.92, 408.45, 232.87, 409.24, 224.17, 407.66, 221.6, 405.28, 221.6, 402.91, 226.54, 395.99, 228.12, 393.02, 229.11, 388.28, 231.88, 383.93, 236.82, 382.74, 241.17]],
                    image_id=245915,
                ...
                AnnotationConfig(
                    ...
                    category_id=22,
                    iscrowd=0,
                    segmentation=[[486.34, 239.01, 477.88, 244.78, 468.26, 245.16, 464.41, 244.78, 458.64, 250.16, 451.72, 249.39, 445.56, 243.62, 448.26, 238.62, 476.72, 206.69, 481.34, 205.54, 485.57, 209.0, 500.0, 205.16, 500.0, 267.47, 500.0, 272.86, 498.26, 276.71, 489.03, 275.94, 488.65, 272.47, 494.8, 251.32, 495.95, 244.39]],
                    image_id=245915,
        ...
        with open(
            os.path.join(
                current_dir, 'testing_data', 'expected_outputs', 'dataset', 'coco_format.json'
            ), 'r'
        ) as f:

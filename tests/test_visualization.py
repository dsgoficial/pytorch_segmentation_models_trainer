...
class Test_TestVisualization(unittest.TestCase):
    ...
    def test_seg_display_real_example(self) -> None:
        ...
        image_seg_display = get_tensorboard_image_seg_display(
            ...
            255*torch.movedim(frame_field_ds[0]['gt_polygons_image'], -1, 0).unsqueeze(0),
        ...
        self.assertEqual(
            compare_images(
                os.path.join(root_dir, 'expected_outputs', 'visualization', 'real_image_seg_display.png'),
                os.path.join(self.output_dir, f"image_seg_display.png"),
                0.001
            ),
            None
    ...
    def test_seg_display(self) -> None:
        ...
        self.assertEqual(
            compare_images(
                os.path.join(root_dir, 'expected_outputs', 'visualization', 'example_image_seg_display.png'),
                os.path.join(self.output_dir, f"image_seg_display.png"),
                0.001
            ),
            None
